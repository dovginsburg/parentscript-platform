...
| **One line** | *Say the right thing at the right time.* |
...
- **De-escalation language first.** Even on a marketing page. *Especially* on a marketing page.
...
**ASO rule:** the first screenshot shows a real script card with a real attribution. No illustrations of smiling families. No "Meet ParentScript." The product sells itself, and the selling point is *clinical credibility*.
...
*Owner: Mark (Marketing Lead). Clinical authority: Mira / Dr. Ariella Eisenberg, PsyD. Engineering: Gary (CTO), Sherlock (infra), Quinn (QA). Last updated 2026-07-05.*