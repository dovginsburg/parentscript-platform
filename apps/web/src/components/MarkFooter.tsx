      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-10 py-10 md:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/pricing" className="text-ps-text-soft hover:text-ps-accent transition-ps">Pricing</Link></li>
              <li><Link to="/signup" className="text-ps-text-soft hover:text-ps-accent transition-ps">For therapists</Link></li>
              <li><Link to="/parent-signup" className="text-ps-text-soft hover:text-ps-accent transition-ps">For parents</Link></li>
              <li><Link to="/sibling" className="text-ps-text-soft hover:text-ps-accent transition-ps">SiblingSupport</Link></li>
              <li><a href="mailto:hello@parentscript.app" className="text-ps-text-soft hover:text-ps-accent transition-ps">Contact sales</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/about" className="text-ps-text-soft hover:text-ps-accent transition-ps">About</Link></li>
              <li><a href="mailto:careers@parentscript.app" className="text-ps-text-soft hover:text-ps-accent transition-ps">Careers</a></li>
              <li><a href="mailto:press@parentscript.app" className="text-ps-text-soft hover:text-ps-accent transition-ps">Press</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/security" className="text-ps-text-soft hover:text-ps-accent transition-ps">Security & HIPAA</Link></li>
              <li><Link to="/privacy" className="text-ps-text-soft hover:text-ps-accent transition-ps">Privacy policy</Link></li>
              <li><Link to="/terms" className="text-ps-text-soft hover:text-ps-accent transition-ps">Terms of service</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-ps-border flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
          ...
          <p className="text-xs text-ps-muted max-w-xl md:text-right">
            {brandLabel} is not a substitute for professional clinical judgment.
        ...
        <div className="mt-8">
          <ScopeOfPracticeDisclosure compact surface={product === 'sibling' ? 'sibling' : 'parent'} />
        </div>

        {/* Hidden home link for router integrity */}
        <Link to={homeLink} className="sr-only">{brandLabel} home</Link>
      </div>
    </footer>
  )
}