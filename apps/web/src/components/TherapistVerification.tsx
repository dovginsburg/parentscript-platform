...
export const SUPPORTED_LICENSE_TYPES: LicenseType[] = [
  'LCSW', 'LMSW', 'LMFT', 'LCMFT', 'LPC', 'LCPC', 'LMHC',
  'PsyD', 'PhD', 'EdD', 'LPA',
  'MD', 'DO', 'NP', 'RN',
  'BCBA', 'BCaBA',
  'RPT', 'LCADC', 'CADC', 'CRC',
    ...
    <form onSubmit={handleSubmit} className={containerClass}>
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Parents trust therapists on ParentScript because we verify clinical
          credentials. Enter your license in the format{' '}
          <code className="bg-gray-100 px-1 rounded text-xs">STATE-TYPE-NUMBER</code>{' '}
          (for example <code className="bg-gray-100 px-1 rounded text-xs">CA-LCSW-12345</code>).
          Verification is reviewed manually by our clinical team within 1–2
          business days.
        </p>
      </div>
