    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="bg-white rounded-xl shadow p-8 max-w-md w-full">
        ...
        <p className="text-sm text-gray-600 mb-4">
          ...
          <code className="bg-gray-100 px-1 rounded">.env</code> and fill in your Supabase project
          URL and anon key.
        </p>
    ...
    fetch(url, { headers: { apikey: key }, signal: controller.signal })
      .then(r => {
        if (r.ok) {
          ...
          setState('broken');
          r.text()
            .then(t => setDetail(`HTTP ${r.status} — ${t.slice(0, 120)}`))
            .catch(() => {});
        }
      })
      .catch(e => {
  ...
  return (
    <>
      ...
      >
        ...
        {detail || 'unknown error'}. Email signup and login will fail until the Supabase project is
        restored. (Logged for support.)
      </div>
    </>
  );
}
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 text-center">
          ...
          <div className="bg-white rounded-xl shadow p-8 max-w-md w-full text-left">
            ...
            <p className="text-sm text-gray-600 mb-3">
              A render error prevented the app from loading. Try closing and reopening the app. If
              this keeps happening, send the message below to support.
            </p>
