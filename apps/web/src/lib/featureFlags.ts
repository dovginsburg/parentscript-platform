...
export const THERAPIST_FLAGS: readonly TherapistFlagMeta[] = [
  {
    ...
    description:
      'Lets parents open the full-screen crisis-style tips page from the home screen.',
  ...
  },
  {
    ...
    description:
      "Download a client's unlock history and practice logs as CSV.",
    category: 'Therapist tools',
    defaultOn: false,
    experimental: true,
  },
...
export const PARENT_PREFS: readonly ParentPrefMeta[] = [
  {
    ...
    description:
      'Display the red panic-mode button at the top of your home screen.',
  ...
  },
  {
    ...
    description:
      'Display the "+ Log practice" link on your home screen.',
    category: 'Home screen',
    defaultOn: true,
  },
  {
  ...
  },
  {
    ...
    label: 'Larger text',
    description:
      'Bumps skill titles and body text up one size for easier reading.',
    category: 'Display',
    defaultOn: false,
  },
  {
    ...
    label: 'Reduce motion',
    description:
      'Disables slide and swipe animations throughout the app.',
    category: 'Display',
    defaultOn: false,
  },
  {
    ...
    description:
      'Shows a confirmation prompt before logging out and similar actions.',
    category: 'Safety',
    defaultOn: true,
  },
]
