      ...
      <main className="flex-1 px-6 md:px-10 py-12 max-w-3xl mx-auto w-full">
        <div className="mb-8">
          ...
          <p className="text-lg text-ps-text-soft leading-relaxed">
            Before you ever see a coach response, SiblingSupport checks your
            message against patterns our clinical team has flagged as high-risk
            — anything that mentions self-harm, suicide, abuse, or violence
            toward your sibling. When that happens, we skip the AI and show you
            this directly:
          </p>
        </div>

        <div className="ps-alert ps-alert-warm mb-8">
          <div className="ps-alert-icon" aria-hidden="true" style={{ background: 'var(--ps-danger-soft)', color: 'var(--ps-danger)' }}>
          ...
          <div className="ps-alert-content">
            <span className="eyebrow" style={{ color: 'var(--ps-danger)' }}>If you or your sibling are in crisis right now</span>
        ...
        <section className="ps-card">
          ...
          <p className="text-ps-text-soft leading-relaxed mb-3">
            A large language model can sound caring but it can also drift — it
            might suggest the wrong thing, or miss the urgency. For moments this
            serious, the right thing isn't a chatbot response. It's a person on
            the other end of a phone line. The numbers above are free, 24/7,
        ...
        <section className="ps-card mt-5">
          ...
          <p className="text-ps-text-soft leading-relaxed mb-3">
            For everything else — sibling conflict, worry, hard conversations,
            feeling overwhelmed — the AI coach can help you slow down, name what
            you're feeling, and try one grounded next step. The coach uses
            active listening, validation, and de-escalation, the same skills a
            school counselor would teach you.
          </p>
          <p className="text-ps-text-soft leading-relaxed">
            The coach is never the only helper. It always reminds you to tell a
            trusted adult if the situation is bigger than you can hold.
          </p>
        </section>
