            ...
            {mode === 'signup' && signupStep === 'checkEmail' ? (
              <div className="space-y-4 text-center" data-testid="signup-check-email">
                <p className="text-sm text-gray-700">
                  ...
                  <strong className="text-gray-900">{signedUpEmail}</strong>. Open it to finish
                  setting up your therapist account — you'll land back here and we'll route you to
                  your clients.
                </p>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {mode === 'signup' && <MagicLinkButton email={email} />}
