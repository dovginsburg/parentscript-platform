    ...
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="text-gray-600">
          This link may be expired or already used. Ask your therapist for a new one.
        </p>
      </div>
    );
  }
        ...
        <div className="max-w-md md:max-w-lg mx-auto w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Your therapist has invited you to join ParentScript.
            </p>
          </div>
            ...
            {step === 'signup' && (
              <>
                ...
                <p className="text-sm text-gray-500 mb-6">
                  You'll use this to access your parenting skills.
                </p>
            ...
            {step === 'confirm' && (
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  We sent a confirmation link to {email}. Open it to finish setup and continue to
                  consent.
                </p>
              </div>
            )}
            ...
            {step === 'consent' && (
              <>
                ...
                <div className="space-y-3 text-sm text-gray-700 mb-6">
                  <p>
                    ✓ <strong>No real names stored.</strong> This app uses a non-identifying label
                    for your case — your name is never saved here.
                  </p>
                  <p>
                    ✓ <strong>No clinical notes.</strong> Your therapist uses structured check-ins
                    only — no free-text records about you or your child.
                  </p>
                  <p>
                    ✓ <strong>This app does not handle emergencies.</strong> For any situation
                    involving danger, call 911. For mental health crisis support, call or text 988.
                  </p>
                  <p>
                    ✓ <strong>Skill content is for general guidance only</strong> and has not been
                    individualized for your child. Always follow your therapist's specific
                    recommendations.
                  </p>
                </div>
