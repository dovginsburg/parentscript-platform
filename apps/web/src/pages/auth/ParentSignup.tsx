            ...
            {step === 'consent' && (
              <form onSubmit={handleConsent} className="space-y-4">
                <div className="space-y-3 text-sm text-gray-700">
                  <p>
                    ✓ <strong>Free tier.</strong> 1 In-the-Moment coaching interaction per day, plus
                    access to L1–L2 skills (Connection & Shaping Behavior).
                  </p>
                  <p>
                  ...
                  <p>
                    ✓ <strong>No clinical notes.</strong> We don&apos;t keep free-text notes about
                    you or your child.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    individualized for your child. Connect with a ParentScript therapist to unlock
                    L3–L5 skills and a tailored plan.
                  </p>
                </div>
