    ...
    <div className="min-h-dvh bg-gray-50 pb-safe-bottom flex flex-col">
      ...
      <header className="bg-white border-b border-gray-100 px-4 md:px-8 pt-safe-top pb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={signOut} className="text-sm text-gray-400 hover:text-gray-600 min-h-tap flex items-center">
            Sign out
          </button>
        </div>
      </header>
          ...
          <>
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-gray-600">
                <span className="font-bold text-brand-700">{unlockedCount}</span>{' '}
                skill{unlockedCount !== 1 ? 's' : ''} unlocked
              </p>
              {showPracticeLog && (
                <Link to="/parent/practice" className="text-sm font-medium text-brand-700 hover:underline min-h-tap flex items-center">
                  + Log practice
                </Link>
              )}
            </div>
                      ...
                      {levelSkills.map(skill =>
                        skill.isUnlocked ? (
                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              <div>
                                <p className="font-bold text-parent-base text-gray-500">{skill.title}</p>
