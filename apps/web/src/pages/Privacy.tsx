      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 md:px-10 py-10 md:py-14">
        <div className="mb-10">
          ...
          <p className="text-base md:text-lg text-ps-text-soft leading-relaxed">
            ...
            We handle Protected Health Information (PHI) under HIPAA.
          </p>
        ...
        <div className="space-y-5">
          <Section eyebrow="1. What we collect" title="Minimum data needed to provide the service.">
            ...
            <ul className="space-y-2 text-ps-text-soft list-disc list-inside">
              <li><strong className="text-ps-text">Account data:</strong> email address, password hash (via Supabase Auth), and optional display name.</li>
              <li><strong className="text-ps-text">Clinical labels:</strong> non-identifying client labels (e.g., "Client 042") chosen by the therapist. We never collect real names, dates of birth, or SSNs.</li>
              <li><strong className="text-ps-text">Skill data:</strong> which skills are unlocked per client, practice logs (good/mixed/hard + optional reflection tags), and therapist note tags.</li>
              <li><strong className="text-ps-text">Verification data:</strong> professional license number, state, and type (therapists only). Used solely for credential verification.</li>
              <li><strong className="text-ps-text">Billing data:</strong> Stripe handles all payment details. We store only subscription plan, status, and Stripe customer/subscription IDs.</li>
              <li><strong className="text-ps-text">Analytics:</strong> none. We do not use Google Analytics, Mixpanel, or similar third-party trackers.</li>
            </ul>
          </Section>

          <Section eyebrow="2. How we use your data" title="Service, verification, billing, and legal compliance.">
            <ul className="space-y-2 text-ps-text-soft list-disc list-inside">
              <li>To provide the ParentScript service (skill unlocking, practice logging, AI coaching).</li>
              ...
              <li>To send essential service emails (password reset, invite links, security alerts). No marketing emails without explicit opt-in.</li>
          ...
          <Section eyebrow="3. How we share your data" title="We do not sell your data.">
            ...
            <ul className="space-y-2 text-ps-text-soft list-disc list-inside">
              <li><strong className="text-ps-text">Supabase</strong> — database hosting, authentication, and row-level security. Data is encrypted in transit and at rest.</li>
              <li><strong className="text-ps-text">Stripe</strong> — payment processing. Stripe receives billing details only; no PHI is shared with Stripe.</li>
              <li><strong className="text-ps-text">Vercel</strong> — static asset hosting. No PHI is stored on Vercel.</li>
              <li><strong className="text-ps-text">AI providers (Anthropic/OpenAI)</strong> — only the situation text entered in "In-the-moment" coaching is sent, with no identifying information. We do not log or retain these requests.</li>
            </ul>
            <p className="mt-4 text-sm text-ps-text-softer">
              We will provide at least 30 days' notice before adding any new sub-processor that handles PHI.
            </p>
          </Section>

          <Section eyebrow="4. Data retention" title="Active records, 6-year audit logs, 35-day backups.">
            <ul className="space-y-2 text-ps-text-soft list-disc list-inside">
              <li><strong className="text-ps-text">Active accounts:</strong> retained while the account is active and for 30 days after cancellation or therapist–parent relationship ends.</li>
              ...
              <li><strong className="text-ps-text">AI coaching interactions:</strong> not logged or retained server-side.</li>
            </ul>
          </Section>

          <Section eyebrow="5. Your rights" title="Access, correction, deletion, export, portability.">
            <ul className="space-y-2 text-ps-text-soft list-disc list-inside">
              <li><strong className="text-ps-text">Access:</strong> request a copy of all data we hold about you.</li>
              <li><strong className="text-ps-text">Correction:</strong> update your account details at any time.</li>
              <li><strong className="text-ps-text">Deletion:</strong> request full account deletion. Completed within 30 days.</li>
              <li><strong className="text-ps-text">Export:</strong> therapists can export client skill state and practice logs.</li>
              <li><strong className="text-ps-text">Portability:</strong> data is stored in standard formats (JSON/CSV) and can be provided on request.</li>
            </ul>
            <p className="mt-4 text-sm text-ps-text-softer">
          ...
          <Section eyebrow="6. Security measures" title="TLS, AES-256, RLS, bcrypt.">
            <ul className="space-y-2 text-ps-text-soft list-disc list-inside">
              ...
              <li>Row-Level Security (RLS) ensures therapists see only their own clients; parents see only their own data.</li>
          ...
          <Section eyebrow="7. Cookies & tracking" title="Essential cookies only. No analytics.">
            <p className="text-ps-text-soft leading-relaxed">
              We use only essential cookies for authentication (Supabase session tokens).
              We do not use tracking cookies, advertising cookies, or third-party analytics.
              The app respects browser Do-Not-Track signals.
            </p>
          </Section>
          ...
          <Section eyebrow="9. Changes to this policy" title="30-day notice for material changes.">
            <p className="text-ps-text-soft leading-relaxed">
              We may update this policy as laws or our practices change. Material changes
